...
\begin{itemize}
  ...
  \item \textbf{Open-source infrastructure}: 953 unit tests (4 skipped for PyFeng SciPy 1.12+ compatibility), CI/CD, PyPI distribution, Sphinx documentation, reproducible artifacts
\end{itemize}
...
The library includes 953 unit tests spanning core infrastructure, cross-validation, and regulatory prototypes, with continuous integration via GitHub Actions.
